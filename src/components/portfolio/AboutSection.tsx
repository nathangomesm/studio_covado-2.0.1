export default function AboutSection() {
  return (
    <section id="sobre" className="secao-padrao bg-fixed bg-center bg-cover relative"
      style={{ backgroundImage: "linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.6)), url('/img/logo-fundo.jpg')" }}>
      <div className="container-custom grid grid-cols-1 md:grid-cols-[1.2fr_0.8fr] gap-12 md:gap-24 items-center relative z-10 text-bege">
        ...
        <div className="animate-fade-in">
          ...
          <div className="space-y-6 text-[1.05rem] text-[#5a4a4a] text-left">
            ...
            <p className="font-bold text-carvalho">Nós criamos o cenário onde a sua vida acontece.</p>
          </div>
        </div>

        {/* Coluna da Imagem */}
        <div className="animate-fade-in">
          <div className="h-[400px] bg-bege relative overflow-hidden">
