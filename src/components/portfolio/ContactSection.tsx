export default function ContactSection() {
  return (
    <section id="contato" className="secao-padrao bg-fixed bg-center bg-cover relative"style={{backgroundImage: "linear-gradient(rgba(0,0,0,0.7), rgba(0,0,0,0.7)), url('/img/logo-fundo.jpg')"}}>
      <div className="container-custom text-center animate-fade-in relative z-10 text-bege">
        ...
        <p className="text-[#5a4a4a] text-[1.05rem] mb-10">
